...
export default function ExtraSections() {
    ...
    <section class="py-16 md:py-24 bg-white">
        <div class="container mx-auto px-4 max-w-3xl">
            ...
            <div class="space-y-4">
                <div class="border border-gray-100 rounded-2xl p-6 bg-gray-50/50 hover:bg-white transition hover:shadow-md cursor-pointer group">
                    <div class="flex justify-between items-center">
                        <h3 class="font-semibold text-gray-900">Can I change or cancel my trip after booking?</h3>
                        <i class="fa-solid fa-chevron-down text-gray-400 group-hover:text-gray-900 transition"></i>
                    </div>
                </div>
                <div class="border border-gray-100 rounded-2xl p-6 bg-gray-50/50 hover:bg-white transition hover:shadow-md cursor-pointer group">
                    <div class="flex justify-between items-center">
            ...
            <div class="text-center mt-12">
                <button class="bg-black text-white px-6 py-3 rounded-full text-sm font-medium hover:bg-gray-800 transition">Explore more questions</button>
            </div>
        </div>
    </section>
    `;
